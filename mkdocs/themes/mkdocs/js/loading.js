...
(function(window){'use strict';
    ...
    function LoadingAction(){
            if("undefined"==typeof jQuery){
                throw new Error("Loading.js requires jQuery");
            }
            
            var Loading = {};
            
            Loading.open = function(properties){
                $('#loading-overlay').remove();//RemoveIfCalledBefore
                var theme = "sk-rect";
                var content = "";
                var message = "";
                ...
                switch(theme){
                    ...
                    default:
                        content = '<div class="sk-rect"> <div class="rect1"></div> <div class="rect2"></div> <div class="rect3"></div> <div class="rect4"></div> <div class="rect5"></div> </div>';
                        console.warn(theme + " doesn't exist for Loading.js");
                    break;
                }
                
                var Loader    = '<div id="loading-overlay" style="display: none;">\n\
                                    <div id="loading-content-container">\n\
                                        <div id="loading-content">'+content+'</div>\n\
                                        <div id="loading-message">'+message+'</div>\n\
                                    </div>\n\
                                </div>';
                
                $(Loader).appendTo('body').fadeIn(300);
                
                if(properties){
                    if(properties.backgroundColor){
                        $("#loading-overlay").css("backgroundColor",properties.backgroundColor);
                    }
                    
                    if(properties.backgroundColor){
                        $("#loading-message").css("color",properties.textColor);
                    }
                }
            };
